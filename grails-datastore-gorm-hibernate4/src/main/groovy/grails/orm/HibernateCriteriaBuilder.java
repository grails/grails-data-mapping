...
public class HibernateCriteriaBuilder extends GroovyObjectSupport implements org.grails.datastore.mapping.query.api.Criteria, org.grails.datastore.mapping.query.api.ProjectionList {
    ...
    public Object invokeMethod(String name, Object obj) {
        ...
        if (isAssociationQueryMethod(args) || isAssociationQueryWithJoinSpecificationMethod(args)) {
            ...
            JoinType joinType = hasMoreThanOneArg ? JoinType.parse((Integer)args[0]) : JoinType.INNER_JOIN;
            ...
            if (pd != null && pd.getReadMethod() != null) {
                ...
                if (type.isAssociationType()) {
                    ...
                    targetClass = sessionFactory.getClassMetadata(otherSideEntityName).getMappedClass();
                    if (targetClass.equals(oldTargetClass) && !hasMoreThanOneArg) {
                        joinType = JoinType.LEFT_OUTER_JOIN; // default to left join if joining on the same table
                    }
    ...
    private void createAliasIfNeccessary(String associationName, String associationPath, JoinType joinType) {
        String newAlias;
