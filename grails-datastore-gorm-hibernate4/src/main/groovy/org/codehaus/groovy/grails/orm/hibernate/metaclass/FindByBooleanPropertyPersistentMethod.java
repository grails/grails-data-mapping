...
public class FindByBooleanPropertyPersistentMethod extends FindByPersistentMethod {
    ...
    public FindByBooleanPropertyPersistentMethod(HibernateDatastore datastore, GrailsApplication application,SessionFactory sessionFactory, ClassLoader classLoader) {
