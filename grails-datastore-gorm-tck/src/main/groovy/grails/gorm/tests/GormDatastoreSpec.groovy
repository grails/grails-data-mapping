...
abstract class GormDatastoreSpec extends Specification {
    ...
    private static final TEST_CLASSES = [Task,Person, Pet, PetType, PersonEvent, Book, Highway,TestEntity, ChildEntity,CommonTypes, Location, City, Country, PlantCategory, Publication]
