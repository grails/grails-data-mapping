...
class HibernateGormStaticApi extends GormStaticApi {
    ...
    HibernateGormStaticApi(Class persistentClass, HibernateDatastore datastore) {
        ...
        this.listMethod = new ListPersistentMethod(sessionFactory, classLoader)
...
class HibernateGormInstanceApi extends GormInstanceApi {
     ...
     */
    def getPersistentValue(Object instance, String fieldName) {
        def session = sessionFactory.currentSession
    ...
    @Override
    Object discard(Object instance) {
    ...
    @Override
    Object delete(Object instance, Map params) {
        def obj = instance
