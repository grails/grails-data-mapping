...
/**
 * Overwrite standard DetachedCriteriaSpec because "Test list method with property projection" test is not correct -
 * currently it assumes that records are returned in creation order ( ["Homer", "Marge"] ) - which is not always correct.
 */
