...
public class GroovyAwareSingleTableEntityPersister extends SingleTableEntityPersister {
    ...
    public GroovyAwareSingleTableEntityPersister(PersistentClass persistentClass, EntityRegionAccessStrategy cacheAccessStrategy, NaturalIdRegionAccessStrategy naturalIdRegionAccessStrategy, PersisterCreationContext creationContext) throws HibernateException {
