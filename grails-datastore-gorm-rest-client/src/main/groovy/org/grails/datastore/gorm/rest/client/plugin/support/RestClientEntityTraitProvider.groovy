...
import grails.gorm.rest.client.RestClientEntity
import org.grails.compiler.gorm.GormEntityTraitProvider


/**
 * Extends {@link org.grails.datastore.gorm.GormEntity} with additional methods specific to REST client operations
 *
