...
class Neo4jPersistentSortedSet extends PersistentSortedSet {
    ...
    Neo4jPersistentSortedSet(Session session, SortedSet collection, EntityAccess parentAccess, Association association) {
    ...
    Neo4jPersistentSortedSet(Collection keys, Session session, EntityAccess parentAccess, Association association) {
    ...
    Neo4jPersistentSortedSet(Serializable associationKey, Session session, AssociationIndexer indexer, EntityAccess parentAccess, Association association) {
